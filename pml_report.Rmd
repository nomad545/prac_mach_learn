...
A final estimate of model accuracy is obtained by applying the stacked function to the testing dataset and comparing the results to the actual class values. 
...
My final estimate of model accuracy is 0.997 (kappa = 0.997). This is an excellent result that is higher than the benchmark published accuracy.
